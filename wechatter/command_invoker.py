...
from wechatter.commands.bili_hot import get_bili_hot_str
from wechatter.commands.copilot_gpt4 import CopilotGPT4
from wechatter.commands.douyin_hot import get_douyin_hot_str
from wechatter.commands.github_trending import get_github_trending_str
from wechatter.commands.pai_post import get_pai_post_str
from wechatter.commands.paper_people import (
    get_paper_people_pdf_url,
    get_paper_people_url,
)
from wechatter.commands.qrcode import generate_qrcode
from wechatter.commands.today_in_history import get_today_in_history_str
from wechatter.commands.todo import add_todo_task, remove_todo_task, view_todos
from wechatter.commands.translate import (
    check_lang_support,
    detect_lang,
...
class CommandInvoker:
    ...
    def cmd_help(to: SendTo, message: str = "") -> None:
        ...
        # 获取帮助信息(图片)
        from wechatter.commands.help import get_help_msg
