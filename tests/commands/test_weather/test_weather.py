...
class TestWeatherCommand(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open('tests/commands/test_weather/hourly_weather.html') as f:
    ...
    def test_parse_hourly_weather_response_bs4_parsing_error(self):
        response = Response()
        response._content = "<html><body><div class='todayRight'></div></body></html>".encode('utf-8')
    ...
    def test_parse_hourly_weather_response_index_error(self):
        response = Response()
        response._content = self.hourly_response.text.replace('var hour3data=', 'var hour').encode('utf-8')
        with self.assertRaises(IndexError):
            weather._parse_hourly_weather_response(response)

    def test_parse_hourly_weather_response_json_decode_error(self):
        response = Response()
        response._content = self.hourly_response.text.replace('var hour3data=[', 'var hour3data=').encode('utf-8')
    ...
    def test_generate_weather_message_success(self):
        h = int(self.c_data["time"].split(":")[0])
        future_weather_list = weather._get_future_weather(
            self.hourly_data["weather"], h, 5
        )
        result = weather._generate_weather_message(self.c_data, self.hourly_data, future_weather_list)
    ...
    def test_get_future_weather_success(self):
        result = weather._get_future_weather(self.hourly_data["weather"], 12, 5)
        true_result = [{'ja': '02', 'jb': '25', 'jc': '0', 'jd': '4', 'je': '77', 'jf': '2024020213'},
                       {'ja': '02', 'jb': '25', 'jc': '0', 'jd': '4', 'je': '76', 'jf': '2024020214'},
                       {'ja': '02', 'jb': '25', 'jc': '0', 'jd': '4', 'je': '76', 'jf': '2024020215'},
                       {'ja': '02', 'jb': '25', 'jc': '0', 'jd': '4', 'je': '76', 'jf': '2024020216'},
                       {'ja': '02', 'jb': '25', 'jc': '0', 'jd': '4', 'je': '76', 'jf': '2024020217'}]
        self.assertListEqual(result, true_result)
        result = weather._get_future_weather(self.hourly_data["weather"], 12, 1)
        true_result = [{'ja': '02', 'jb': '25', 'jc': '0', 'jd': '4', 'je': '77', 'jf': '2024020213'}]
        self.assertListEqual(result, true_result)

    def test_get_future_weather_empty_list(self):
        result = weather._get_future_weather([], 23, 5)
