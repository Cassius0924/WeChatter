...
function WeatherCron() {
    const [config, setConfig] = useFetchData('weather-cron');
    const handleSave = useSaveConfig('weather-cron', config);
            ...
            <div className="flex flex-col items-center justify-center h-full">
                <div className="text-center">
                    ...
                    <input type="text"
                           ...
                           placeholder="False"
                           value={config.weather_cron_enabled || ''}
                           onChange={e => setConfig({...config, weather_cron_enabled: e.target.value})}/>
                    <h3 className="mb-4 text-lg leading-6 font-medium text-gray-900">
                    ...
                    <textarea
                        ...
                        value={config.weather_cron_rule_list || ''}
                        onChange={e => setConfig({...config, weather_cron_rule_list: e.target.value})}/>
                    <button
                        onClick={handleSave}
